...
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Sudhakaran_Gate-Shift_Networks_for_Video_Action_Recognition_CVPR_2020_paper.html) · 📚 被引 155
- **作者**: Swathikiran Sudhakaran, Sergio Escalera, Oswald Lanz
- **🏷️ 机构**: （机构待查）
- **会议**: CVPR 2020

### Spatio-Temporal Graph for Video Captioning With Knowledge Distillation.
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Pan_Spatio-Temporal_Graph_for_Video_Captioning_With_Knowledge_Distillation_CVPR_2020_paper.html) · 📚 被引 213
