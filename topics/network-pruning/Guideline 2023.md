...
- **链接**: [arXiv:2305.11627](https://arxiv.org/abs/2305.11627) · [代码](https://github.com/horseee/LLM-Pruner) · 📚 被引 89
...
- **链接**: [出版页](http://papers.nips.cc/paper_files/paper/2023/hash/fd5013ea0c3f96931dec77174eaf9d80-Abstract-Conference.html) · 📚 被引 1
- **作者**: Hoang Pham, The-Anh Ta, Shiwei Liu, Lichuan Xiang, Dung Le, Hongkai Wen et al.
- **🏷️ 机构**: （机构待查）
- **会议**: NeurIPS 2023

### Greedy Pruning with Group Lasso Provably Generalizes for Matrix Sensing.
- **链接**: [出版页](http://papers.nips.cc/paper_files/paper/2023/hash/bd2107343c9cc973635d90dbfc122223-Abstract-Conference.html) · 📚 被引 1
...
- **链接**: [arXiv:2306.03805](https://arxiv.org/abs/2306.03805) · [代码](https://github.com/VITA-Group/essential_sparsity) · 📚 被引 1
