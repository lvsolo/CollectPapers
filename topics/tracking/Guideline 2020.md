...
- **链接**: [arXiv:2003.12565](https://arxiv.org/abs/2003.12565) · [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Danelljan_Probabilistic_Regression_for_Visual_Tracking_CVPR_2020_paper.html) · [代码](https://github.com/visionml/pytracking) · 📚 被引 703
...
- **链接**: [arXiv:2112.14016](https://arxiv.org/abs/2112.14016) · [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Gao_Recursive_Least-Squares_Estimator-Aided_Online_Learning_for_Visual_Tracking_CVPR_2020_paper.html) · 📚 被引 16
...
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Guo_SiamCAR_Siamese_Fully_Convolutional_Classification_and_Regression_for_Visual_Tracking_CVPR_2020_paper.html) · 📚 被引 849
...
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Huang_SQE_a_Self_Quality_Evaluation_Metric_for_Parameters_Optimization_in_CVPR_2020_paper.html) · 📚 被引 7
- **作者**: Yanru Huang, Feiyu Zhu, Zheni Zeng, Xi Qiu, Yuan Shen, Jianan Wu
- **🏷️ 机构**: （机构待查）
- **会议**: CVPR 2020

### AutoTrack: Towards High-Performance Visual Tracking for UAV With Automatic Spatio-Temporal Regularization.
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Li_AutoTrack_Towards_High-Performance_Visual_Tracking_for_UAV_With_Automatic_Spatio-Temporal_CVPR_2020_paper.html) · 📚 被引 397
...
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Porzi_Learning_Multi-Object_Tracking_and_Segmentation_From_Automatic_Annotations_CVPR_2020_paper.html) · 📚 被引 59
...
- **链接**: [出版页](https://openaccess.thecvf.com/content_CVPR_2020/html/Yin_A_Unified_Object_Motion_and_Affinity_Model_for_Online_Multi-Object_CVPR_2020_paper.html) · 📚 被引 105
